...
class QuizQuestionsActivity1 : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ll_progress_details = findViewById(R.id.ll_progress_details1)
        progressBar = findViewById(R.id.progressBar1)
        tv_progress = findViewById(R.id.tv_progress1)
        tv_option_one = findViewById(R.id.tv_option_one1)
        tv_option_two = findViewById(R.id.tv_option_two1)
        tv_option_three = findViewById(R.id.tv_option_three1)
        tv_option_four = findViewById(R.id.tv_option_four1)
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(Constants1.CORRECT_ANSWERS1, mCorrectAnswers)
                            intent.putExtra(Constants1.TOTAL_QUESTIONS1, mQuestionsList!!.size)
